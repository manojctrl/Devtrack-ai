  ...
  return (
    <div className="bg-[#1E293B] border border-white/7 rounded-[20px] p-5">
      <div className="text-[13px] font-semibold text-slate-400 uppercase tracking-[0.08em] mb-4 flex items-center gap-1.5">
        <i className="ti ti-rosette-discount-check text-indigo-500 text-[16px]" /> Resume Readiness
      </div>
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          <div className="text-[14px] font-semibold text-slate-200 mb-1">Almost there!</div>
      ...
      <div className="grid grid-cols-2 gap-2">
        {STATS.map((s) => (
          <div key={s.label} className="bg-white/2 border border-white/4 rounded-[10px] p-2.5 text-center">
            <div className={`text-[16px] font-bold font-mono mb-0.5 ${s.color}`}>{s.value}</div>
